...
/**
 `MGLSource` is an abstract base class for map sources. A source supplies
 content to be shown on the map. A source is added to an `MGLStyle` object along
 with an `MGLForegroundStyleLayer` object. The foreground style layer defines
 the appearance of any content supplied by the source.
 ...
 `MGLGeoJSONSource`, `MGLRasterSource`, and `MGLVectorSource`.
 */
